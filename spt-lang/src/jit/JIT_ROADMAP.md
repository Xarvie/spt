...
- **方法内联**：纯读方法(§10.46)、单尾写 void 方法(§10.49)、写后返同字段方法(§10.52 存转载前推)、
  ...
  **嵌套内联多帧基础设施**(§10.68a 栈化 SPTInlineFrame 数组 + §10.68b 放开 frame_base!=0 abort + 安全网保证正确性，为阶段 3 通用 resume-at-call 铺路)。
