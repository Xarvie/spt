...
#include "lopnames.h"
    ...
    vmdispatch(GET_OPCODE(i)) {
      ...
      /* ========================================================================
       * VM FIXES FOR GENERIC FOR LOOP - CORRECT OPCODE ORDER
       * ======================================================================== */

      /* OP_FORLOOP - unchanged */
      vmcase(OP_FORLOOP) {
        StkId ra = RA(i);
