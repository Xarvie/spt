...
public:
  ...
  virtual std::any
  visitVariableDeclarationDef(LangParser::VariableDeclarationDefContext *context) = 0;

  virtual std::any
  visitMutiVariableDeclarationDef(LangParser::MutiVariableDeclarationDefContext *context) = 0;

  virtual std::any visitDeclaration_item(LangParser::Declaration_itemContext *context) = 0;

  virtual std::any
  visitFunctionDeclarationDef(LangParser::FunctionDeclarationDefContext *context) = 0;

  virtual std::any visitMultiReturnFunctionDeclarationDef(
      LangParser::MultiReturnFunctionDeclarationDefContext *context) = 0;
  ...
  virtual std::any
  visitMultiReturnClassMethodMember(LangParser::MultiReturnClassMethodMemberContext *context) = 0;
  ...
  virtual std::any
  visitTypeQualifiedIdentifier(LangParser::TypeQualifiedIdentifierContext *context) = 0;
