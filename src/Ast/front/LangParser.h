...
public:
  enum {
    ...
    MUL = 38, DIV = 39, IDIV = 40, MOD = 41, ASSIGN = 42, ADD_ASSIGN = 43, 
    SUB_ASSIGN = 44, MUL_ASSIGN = 45, DIV_ASSIGN = 46, IDIV_ASSIGN = 47, 
    MOD_ASSIGN = 48, CONCAT_ASSIGN = 49, EQ = 50, NEQ = 51, LT = 52, GT = 53, 
    LTE = 54, GTE = 55, AND = 56, OR = 57, NOT = 58, CONCAT = 59, LEN = 60, 
    BIT_AND = 61, BIT_OR = 62, BIT_XOR = 63, BIT_NOT = 64, LSHIFT = 65, 
    ARROW = 66, OP = 67, CP = 68, OSB = 69, CSB = 70, OCB = 71, CCB = 72, 
    COMMA = 73, DOT = 74, COL = 75, SEMICOLON = 76, DDD = 77, INTEGER = 78, 
    FLOAT_LITERAL = 79, STRING_LITERAL = 80, IDENTIFIER = 81, WS = 82, LINE_COMMENT = 83, 
    BLOCK_COMMENT = 84
  };
