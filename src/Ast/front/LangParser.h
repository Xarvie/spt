...
public:
  ...
  enum {
    ...
    RuleBlockStatement = 1,
    RuleStatement = 2,
    RuleImportStatement = 3,
    RuleImportSpecifier = 4,
    RuleDeferStatement = 5,
    RuleUpdateStatement = 6,
    RuleAssignStatement = 7,
    RuleLvalue = 8,
    RuleLvalueSuffix = 9,
    RuleDeclaration = 10,
    RuleVariableDeclaration = 11,
    RuleDeclaration_item = 12,
    RuleFunctionDeclaration = 13,
    RuleClassDeclaration = 14,
    RuleClassMember = 15,
    RuleType = 16,
    RuleQualifiedIdentifier = 17,
    RulePrimitiveType = 18,
    RuleListType = 19,
    RuleMapType = 20,
    RuleExpression = 21,
    RuleExpressionList = 22,
    RuleLogicalOrExp = 23,
    RuleLogicalAndExp = 24,
    RuleBitwiseOrExp = 25,
    RuleBitwiseXorExp = 26,
    RuleBitwiseAndExp = 27,
    RuleEqualityExp = 28,
    RuleEqualityExpOp = 29,
    RuleComparisonExp = 30,
    RuleComparisonExpOp = 31,
    RuleShiftExp = 32,
    RuleShiftExpOp = 33,
    RuleConcatExp = 34,
    RuleAddSubExp = 35,
    RuleAddSubExpOp = 36,
    RuleMulDivModExp = 37,
    RuleMulDivModExpOp = 38,
    RuleUnaryExp = 39,
    RulePostfixExp = 40,
    RulePostfixSuffix = 41,
    RulePrimaryExp = 42,
    RuleAtomexp = 43,
    RuleLambdaExpression = 44,
    RuleListExpression = 45,
    RuleMapExpression = 46,
    RuleMapEntryList = 47,
    RuleMapEntry = 48,
    RuleNewExp = 49,
    RuleIfStatement = 50,
  ...
  public:
    ...
    antlr4::tree::TerminalNode *COROUTINE();
  ...
  class MapEntryIntKeyContext : public MapEntryContext {
  public:
    MapEntryIntKeyContext(MapEntryContext *ctx);
  ...
  class MapEntryFloatKeyContext : public MapEntryContext {
  public:
    MapEntryFloatKeyContext(MapEntryContext *ctx);
